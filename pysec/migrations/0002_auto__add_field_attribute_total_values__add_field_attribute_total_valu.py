...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attribute.total_values'
        db.add_column(u'pysec_attribute', 'total_values',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Attribute.total_values_fresh'
        db.add_column(u'pysec_attribute', 'total_values_fresh',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attribute.total_values'
        db.delete_column(u'pysec_attribute', 'total_values')

        # Deleting field 'Attribute.total_values_fresh'
        db.delete_column(u'pysec_attribute', 'total_values_fresh')
