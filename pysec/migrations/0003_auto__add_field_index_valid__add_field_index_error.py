...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Index.valid'
        db.add_column(u'pysec_index', 'valid',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)

        # Adding field 'Index.error'
        db.add_column(u'pysec_index', 'error',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Index.valid'
        db.delete_column(u'pysec_index', 'valid')

        # Deleting field 'Index.error'
        db.delete_column(u'pysec_index', 'error')
