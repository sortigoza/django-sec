...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Index.attributes_loaded'
        db.add_column(u'pysec_index', 'attributes_loaded',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Index.attributes_loaded'
        db.delete_column(u'pysec_index', 'attributes_loaded')
